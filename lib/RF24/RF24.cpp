...
inline void wait_ms(uint16_t ms)
{
  thread_sleep_for(ms);
}
...
#endif
/****************************************************************************/
RF24::RF24(PinName mosi, PinName miso, PinName sck, PinName _cepin, PinName _csnpin) : spi(mosi, miso, sck), ce_pin(_cepin), csn_pin(_csnpin), p_variant(true),
